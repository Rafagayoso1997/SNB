   ...
   /* @FXML
    ...
    private void initialize() {
        ...
        if(calendarsList.size() == 1){
            ...
            barChartCalendar.setCategoryGap(600);
            barChartLessTeam.setBarGap(0);
            barChartLessTeam.setCategoryGap(600);
            barChartMoreTeam.setBarGap(0);
            barChartMoreTeam.setCategoryGap(600);
        }
        ...
        for(int i =0; i < calendarsList.size();i++){
            ...
            statistics = controller.lessStatistics(itinerary);
            ...
            statistics = controller.moreStatistics(itinerary);
