...
public class DoubleRoundChampionNonSymmetricOddCalendar extends Calendar {

    DoubleRoundChampionNonSymmetricOddCalendar(CalendarConfiguration configuration){
        super(configuration);
    }
