...
public class DoubleRoundInauguralNonSymmetricOddCalendar extends Calendar{

    DoubleRoundInauguralNonSymmetricOddCalendar(CalendarConfiguration configuration) {
        super(configuration);
    }
