...
public class DoubleRoundInauguralNonSymmetricPairCalendar extends Calendar{

    DoubleRoundInauguralNonSymmetricPairCalendar(CalendarConfiguration configuration) {
        super(configuration);
    }
