...
public class DoubleRoundInauguralOccidentSymmetricOddCalendar extends Calendar implements IOccidentVsOrient {
    DoubleRoundInauguralOccidentSymmetricOddCalendar(CalendarConfiguration configuration) {
        super(configuration);
    }
