...
public class DoubleRoundInauguralOccidentSymmetricPairCalendar extends Calendar implements IOccidentVsOrient {
    DoubleRoundInauguralOccidentSymmetricPairCalendar(CalendarConfiguration configuration) {
        super(configuration);
    }
