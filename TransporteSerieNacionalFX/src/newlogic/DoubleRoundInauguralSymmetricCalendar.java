...
import interfaces.IDoubleRoundInauguralSymmetric;
import logic.Date;

import java.util.ArrayList;

public class DoubleRoundInauguralSymmetricCalendar extends Calendar implements IDoubleRoundInauguralSymmetric {
    @Override
