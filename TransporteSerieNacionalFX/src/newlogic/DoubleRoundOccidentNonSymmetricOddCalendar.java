...
public class DoubleRoundOccidentNonSymmetricOddCalendar extends Calendar implements IOccidentVsOrient {

     DoubleRoundOccidentNonSymmetricOddCalendar(CalendarConfiguration configuration) {
        super(configuration);
    }
