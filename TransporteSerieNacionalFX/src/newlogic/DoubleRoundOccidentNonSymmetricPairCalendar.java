...
public class DoubleRoundOccidentNonSymmetricPairCalendar extends Calendar implements IOccidentVsOrient {

     DoubleRoundOccidentNonSymmetricPairCalendar(CalendarConfiguration configuration) {
        super(configuration);
    }
