...
public class DoubleRoundOccidentSymmetricPairCalendar extends Calendar implements IOccidentVsOrient {

    DoubleRoundOccidentSymmetricPairCalendar(CalendarConfiguration configuration) {
        super(configuration);
    }
