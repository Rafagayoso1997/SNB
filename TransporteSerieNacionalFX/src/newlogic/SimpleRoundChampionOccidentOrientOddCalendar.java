...
public class SimpleRoundChampionOccidentOrientOddCalendar extends Calendar implements IOccidentVsOrient {

    SimpleRoundChampionOccidentOrientOddCalendar(CalendarConfiguration configuration) {
        super(configuration);
    }
