...
public class SimpleRoundInauguralOccidentOddCalendar extends Calendar implements IOccidentVsOrient {

    SimpleRoundInauguralOccidentOddCalendar(CalendarConfiguration configuration) {
        super(configuration);
    }
