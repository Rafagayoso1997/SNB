...
public class SimpleRoundInauguralOccidentPairCalendar extends Calendar implements IOccidentVsOrient {

    SimpleRoundInauguralOccidentPairCalendar(CalendarConfiguration configuration) {
        super(configuration);
    }
