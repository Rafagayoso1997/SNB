...
public class SimpleRoundOccidentOrientOddCalendar extends Calendar implements IOccidentVsOrient {

    SimpleRoundOccidentOrientOddCalendar(CalendarConfiguration configuration) {
        super(configuration);
    }
