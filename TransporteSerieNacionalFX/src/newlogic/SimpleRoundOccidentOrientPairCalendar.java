...
public class SimpleRoundOccidentOrientPairCalendar extends Calendar implements IOccidentVsOrient {

    SimpleRoundOccidentOrientPairCalendar(CalendarConfiguration configuration) {
        super(configuration);
    }
